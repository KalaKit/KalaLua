...
There is also a third advanced caller which expects you to handle lua_State, this is only recommended for advanced users as it requires you to link against the Lua dll and use Lua source code.
